# [Check Consonants and Vowels](https://www.geeksforgeeks.org/problems/consonants-and-vowels-check-java/1)
## Easy
...
Input: s = aaaaaa
Output: Yes
Input: s = ababOutput: Same
Constraints:1 ≤ |s| ≤ 100Where, |s| is the size of string.